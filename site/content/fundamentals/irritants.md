...
to escape. Like the ISO FEC, the FIC is a concentration criterion and is
...
escape calculation", but in the simplified asphyxiant equation he includes
...
values used animals, mostly rodents (Ch. 63). The endpoint concentrations
...
400–600 ppm. The concentrations of acrolein and formaldehyde are rarely known
in a fire, and Ch. 63 suggests a smoke-density surrogate when they are not.

## Sources

- ISO 13571:2012, §4.2 and §5.4.
...
- D. A. Purser and J. L. McAllister (2016). *SFPE Handbook*, 5th ed., Ch. 63,
  Eqs. 63.11, 63.13–63.15, 63.38, Tables 63.6–63.7.
  [doi:10.1007/978-1-4939-2565-0_63](https://doi.org/10.1007/978-1-4939-2565-0_63)
- T. Korhonen (2021). *FDS+Evac Technical Reference and User's Guide*,
  §3.4. VTT Technical Research Centre of Finland. Secondary source.

How pyFDS-Evac uses this: see [Fractional effective dose](/models/fed.md).
pyFDS-Evac calls its instantaneous irritant concentration FIC.
