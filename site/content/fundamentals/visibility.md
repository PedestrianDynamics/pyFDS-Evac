...
was almost constant (Yamada and Akizuki 2016, Society of Fire Protection
Engineers (SFPE) Handbook Ch. 61, Eq. 61.4). Ch. 61
...
light-reflecting sign, citing Mulholland in the SFPE Handbook, and uses
*C* = 3 by default (`VISIBILITY_FACTOR`). FDS reports visibility up to a
maximum of 30 m by default (`MAXIMUM_VISIBILITY`).
...
(Ch. 61). Later experiments in non-irritant white smoke without background
light found the constant tends to be larger than Jin's values; ordinary
light-emitting exit signs were lost at about 10 m in smoke of \(C_s\) =
1.0 1/m (Ch. 61). Visibility in black (flaming) smoke was somewhat better than
...
Fig. 61.11, from Jin's corridor experiments).
...
- T. Jin (1978). Visibility through fire smoke. *Journal of Fire &
  Flammability* 9:135–157. No DOI; read through Ch. 61 and Ronchi et
  al. (2013).
- T. Yamada and Y. Akizuki (2016). Visibility and human behavior in fire
  smoke. *SFPE Handbook*, 5th ed., Ch. 61, 2181–2206.
  [doi:10.1007/978-1-4939-2565-0_61](https://doi.org/10.1007/978-1-4939-2565-0_61)
- K. McGrattan et al. *FDS User's Guide*, National Institute of Standards and Technology (NIST) SP 1019, 6th ed., revision
  FDS-6.10.1-0-g12efa16, §22.10.5.
  [github.com/firemodels/fds/releases](https://github.com/firemodels/fds/releases)
