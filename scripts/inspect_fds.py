...
Usage:
    uv run python scripts/inspect_fds.py fds_directory/demo
    uv run python scripts/inspect_fds.py fds_directory/demo --plot
    uv run python scripts/inspect_fds.py fds_directory/demo --height 2.0 --plot
"""
