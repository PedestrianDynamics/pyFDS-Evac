...
| `fed_incap_heat_100c`<br>`fed_incap_heat_150c`<br>`fed_incap_heat_200c` | Sealed uniform room at three constant gas temperatures (heat FED, ISO TS 13571 eq. 5), 100 non-evacuating agents, 4 MPI meshes. Same `config.json`/`geometry.wkt` as the CO ladder. | deck | [testing-heat.md](../docs/testing-heat.md) |
